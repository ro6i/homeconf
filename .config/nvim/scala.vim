...
syn match scalaNameDefinition /\<[_A-Za-z0-9$]\+\>/ contained nextgroup=scalaPostNameDefinition,scalaVariableDeclarationList contains=scalaSuperCapital4
...
syn match scalaInstanceDeclaration /\<[_\.A-Za-z0-9$]\+\>/ contained nextgroup=scalaInstanceHash contains=scalaSuperCapital1
...
syn match scalaCapitalWord /\<[A-Z][A-Za-z0-9$]*\>/ contains=scalaSuperCapital2
...
syn match scalaTypeDeclaration /\<[_\.A-Za-z0-9$]\+\>/ contained nextgroup=scalaTypeExtension skipwhite contains=scalaSuperCapital3
...
syn match scalaSuperCapital1 /[A-Z]\([a-z]\)\@=/
syn match scalaSuperCapital5 /[A-Z]\([a-z]\)\@=/
syn match scalaSuperCapital4 /[A-Z]\([a-z]\)\@=/
syn match scalaSuperCapital3 /[A-Z]\([a-z]\)\@=/
syn match scalaSuperCapital2 /[A-Z]\([a-z]\)\@=/
...
syn region scalaString start=/"/ end=/"/ contains=scalaStringEmbeddedQuote,scalaEscapedChar,scalaUnicodeChar,scalaSuperCapital5
